...
using System.Linq;
using CooldownTracker.Properties;
using LeagueSharp;
...
namespace CooldownTracker
{
    internal class Program
    {
        ...
        {
            MainMenu = new Menu("[KH] CooldownTracker", "SkillBar", true);
        ...
        {
            Game.PrintChat("<font color = \"#00FF2B\">SkillBar</font> by <font color = \"#FD00FF\">kaigan</font> - Loaded!");
        }
    }
