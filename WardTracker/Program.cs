...
namespace WardTracker
{
    internal class Program
    {
        ...
        {
            MainMenu = new Menu("[KH] Ward Tracker", "WardTracker", true);
        ...
        {
            Game.PrintChat("<font color = \"#00FF2B\">WardDetector</font> by <font color = \"#FD00FF\">kaigan</font> - Loaded!");
        }
    }
