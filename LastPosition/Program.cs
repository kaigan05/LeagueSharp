...
namespace LastPosition
{
    internal class Program
    {
        ...
        {
            MainMenu = new Menu("[KH] Last Potion (F5)", "Last Position", true);
        ...
        {
            Game.PrintChat("<font color = \"#00FF2B\">LastPosition</font> by <font color = \"#FD00FF\">kaigan</font> - Loaded!");
        }
    }
